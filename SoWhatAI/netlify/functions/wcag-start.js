...
function resolveStoreExports(moduleRef) {
...
async function loadJobStore() {
  ...
  return resolveStoreExports(moduleRef);
}
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    createJob = typeof store.createJob === 'function' ? store.createJob : null;
    failJob = typeof store.failJob === 'function' ? store.failJob : failJob;
  } catch (error) {
    return json(200, {
      jobId,
      status: 'failed',
